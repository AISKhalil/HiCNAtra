function [segmentStart, segmentEnd, longSegmentStart, longSegmentEnd] = rdSavitzkySegmentation(obj, targetChrIndex)
%Segmentation of the RD signal using Savitzky-Golay filter and modified-Varri techniques.

signal = obj.chrFNDictionary(targetChrIndex)*2/obj.CNReference;
dataLen = length(signal);
%
binSize = obj.binSize;
CNVsSegmentsFrequency = round(obj.resolution/(0.1));%Assuming that at minimum 90% of the genome is free of focal CNVs.
minimumIBsize = round(obj.minimumIBsize/binSize);
