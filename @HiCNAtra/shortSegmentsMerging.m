function [finalSegmentStart, finalSegmentEnd] = shortSegmentsMerging(obj, targetChrIndex, orgSegmentStart, orgSegmentEnd)
%Merging short regions with similar RD value to build the iso-copy numeric blocks. 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%------------------------------ Parameters -----------------------%%
% maximum segment size (to define final segments).
binSize = obj.binSize;
userMinSegmentSize = round(obj.minimumIBsize/binSize);

% RD-signal
orgSignal = obj.chrFNDictionary(targetChrIndex)*2/obj.CNReference;
