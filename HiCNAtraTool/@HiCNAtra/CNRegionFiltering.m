function [finalSegmentInfo, impRegionsPerSegment] = CNRegionFiltering(obj, chrIndex, segmentsInfo, regionsPerSegment)
%Filtering out the significant regions around centromeres, telomeres, black-listed areas, low-mappability areas, and low GC-ratio areas.
%Filtering out regions based on the minimum alternation rank.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% ----------------------------------------- Parameters ---------------------------------------- %%

signal = obj.chrFNDictionary(chrIndex)*2/obj.CNReference;

minImpCategory = 5; % minimum Cateogry for a region to be considered as alternation.
...
%%% Data-indices & centromeres/telomeres %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
refIndices = obj.chrFIndex(chrIndex);
%
...
for i = 1: noSegments
    ...
    if(noRegions > 0)
            ...
            for j = 1: noImpRegions
                ...
                %Region Width
                cond4 = ((iRegionWidth <= minRegionSize) && (abs(iRegionRD - segmentCN) <= 2));
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
