function obj = HiCNormNormalization(obj)
...
preNormFilePath = strcat(dir, '/', 'contactMapPreNorm_HiCNorm',int2str(obj.contactMapBinSize),'.xls');
postNormFilePath = strcat(dir, '/', 'contactMapPostNorm_HiCNorm',int2str(obj.contactMapBinSize),'.xls');
%
A = preNormArray;
